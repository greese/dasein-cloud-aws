...
public class ElasticLoadBalancer extends AbstractLoadBalancerSupport<AWSCloud> {
    ...
    public SSLCertificateMetadata createSSLCertificate(@Nonnull SSLCertificateCreateOptions options) throws CloudException, InternalException {
        ...
        try {
            ...
            provider.putValueIfNotNull(parameters, "ServerCertificateName", options.getCertificateId());
    ...
    public @Nullable SSLCertificate getSSLCertificate(@Nonnull String certificateId) throws CloudException, InternalException {
        ...
        try {
            ...
            parameters.put("ServerCertificateName", certificateId);
            Document doc;
    ...
    public void setSSLCertificate(@Nonnull SetLoadBalancerSSLCertificateOptions options)
        ...
        try {
            ...
            parameters.put("SSLCertificateId", options.getProviderSslCertificateId());
...
//TODO: remove set as NoOp
    ...
    private @Nullable SSLCertificateMetadata toSSLCertificateMetadata(@Nullable Node node) {
        ...
        return SSLCertificateMetadata.getInstance(arn, path, id, uploadDate);
    }
